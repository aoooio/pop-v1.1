...
const es = require("./poc-elastic7-client.js")();
              ...
              return new Observable(async observer => {
                ...
                while (true) {
                  ...
                  for (let i in notices) {
                    ...
                    bulk.push({
                      update: { _index: dbname, _type: '_doc', _id: notice._id }
                    });
                    delete notice._id;
                  ...
                  if (bulk.length) {
                    ...
                    if (res.body.errors) {
                      observer.error({
                        ...
                        sampleError: JSON.stringify(res.body.items),
